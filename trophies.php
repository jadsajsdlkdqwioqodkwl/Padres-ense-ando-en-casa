...
<head>
    ...
    <style>
        ...
        .trophy-card { background: var(--light); border-radius: 20px; padding: 20px; text-align: center; border: 2px solid var(--border-color); transition: 0.3s; position: relative; overflow: hidden; }
        ...
        <?php else: ?>
            <div class="trophy-grid">
                <?php foreach ($learned_items as $item): ?>
                    <div class="trophy-card" onclick="playTTS('<?php echo addslashes($item['en']); ?>', 'en-US')" style="cursor: pointer;" title="Toca para escuchar">
